...
public:
	...
	friend class EFPlane;
	friend class EFResidual;
	friend class EFPResidual;
	...
	int nPoints, nPlanes, nFrames, nResiduals;
...
private:
    ...
    void resubstituteFPl(const VecCf &xc, Mat18f* xAd, int min, int max, Vec10* stats, int tid);
