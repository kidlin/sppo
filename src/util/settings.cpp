...
float setting_minINormalH_marg = 10000000;
...
bool setting_showImmaturePoint=false;
bool setting_showCurrentPoint=false;
...
// paras for plane detection
// an image is divided into setting_numGridx x setting_numGridy
// for three eigenvalue e1,e2,e3 (e1<e2<e3),
// a plane must satisfy minEigenvalueReq*e1<e3 and setting_maxEigenvalueReq*e2>e3
int setting_numGridx=10;
int setting_numGridy=8;
int setting_minPointsForClustering=20;
float setting_minEigenvalueReq=1000;
float setting_maxEigenvalueReg=10;
float setting_minDisTwoPatches=0.01;
float setting_maxCosTwoPatches=0.99;
...
bool setting_pauseProcess=false;
